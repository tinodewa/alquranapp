...
public class Query {
    ...
    public static String ReportKaderAdmin2(String cabang){
        return "SELECT * FROM Contact WHERE id_level = " + Constant.USER_LK_1 + " AND cabang = '"+cabang+"'";
    }
    ...
    public static String countReportKaderAdmin2(String cabang){
        return "SELECT COUNT (*) FROM Contact WHERE id_level = " + Constant.USER_LK_1 + " AND cabang = '"+cabang+"'";
    }
    public static String countReportKaderAdmin2L(String cabang){
        return "SELECT COUNT (*) FROM Contact WHERE id_level = " + Constant.USER_LK_1 + " AND cabang = '"+cabang+"' AND jenis_kelamin = '0'";
    }
    public static String countReportKaderAdmin2P(String cabang){
        return "SELECT COUNT (*) FROM Contact WHERE id_level = " + Constant.USER_LK_1 + " AND cabang = '"+cabang+"' AND jenis_kelamin = '1'";
    }
